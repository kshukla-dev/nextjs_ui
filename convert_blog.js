...
const tsxContent = fs.readFileSync(path.join(__dirname, 'app/blog/page.tsx.part'), 'utf-8');
const vueContent = fs.readFileSync(path.join(__dirname, '../src/pages/BlogPage.vue'), 'utf-8');
...
fs.writeFileSync(path.join(__dirname, 'app/blog/page.tsx'), finalTsx, 'utf-8');
console.log('Created app/blog/page.tsx successfully!');
