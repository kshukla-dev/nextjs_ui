    ...
    <>
      ...
      <section className="eor-section lg:py-24 bg-white">
        <div className="max-w-300 mx-auto px-4 sm:px-6 lg:px-8">
          <SectionTitle
            title="What is Contractor Management in Italy?"
            description="Contractor management helps you engage freelancers and independent contractors compliantly under Italian law without the complexity of setting up an entity (S.r.l./S.p.A.) or risking misclassification and INPS liability."
            align="left"
          />
            ...
            <div className="group flex flex-col rounded-2xl border border-gray-200 bg-white shadow-sm hover:shadow-lg hover:border-primary/25 transition-all duration-300 text-left overflow-hidden relative min-h-[220px]">
              ...
              <div className="flex flex-1 flex-col justify-center p-6 sm:p-8">
                ...
                <p className="text-gray-600 leading-relaxed text-sm sm:text-base">
                  Companies hiring freelancers, consultants, or project-based contractors in Italy without a local entity. Ideal for tech, fashion, luxury goods, manufacturing, consulting, and creative industries in Milan, Rome, Turin, and across Italy.
                </p>
              </div>
            </div>
            <div className="group flex flex-col rounded-2xl border border-gray-200 bg-white shadow-sm hover:shadow-lg hover:border-primary/25 transition-all duration-300 text-left overflow-hidden relative min-h-[220px]">
          ...
          <p className="text-center mt-8 w-full ">
            <Link href="/italy" className="text-primary font-medium hover:underline inline-flex items-center gap-1 ">
              Need to hire employees instead? See Italy EOR <ArrowRight className="w-4 h-4" />
            </Link>
          </p>
        </div>
      </section>
        ...
        <div className="max-w-300 mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-4xl">
            ...
            <h2 className="section-title text-3xl sm:text-4xl lg:text-5xl font-bold text-primary mb-5 leading-tight">
              Mastering Contractor Classification for Business Expansion in Italy
            </h2>
            
            <div className="space-y-4">
              <p className="text-sm sm:text-base  text-gray-600 leading-relaxed">
                Unleash your business potential in Italy with strategic hiring. Learn the intricacies of classifying independent contractors to sidestep fines and penalties.
              </p>
              <p className="text-sm sm:text-base  text-gray-600 leading-relaxed">
                Jackson and Frank provide expert guidance tailored to the Italian classification landscape, ensuring compliance and success in this dynamic market.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="order-2 lg:order-1 relative h-[400px] rounded-2xl overflow-hidden ">
              <Image
                ...
                alt="Seamless Contractor Onboarding in Italy"
            ...
            <div className="order-1 lg:order-2">
              <h2 className="section-title text-3xl sm:text-4xl  font-bold text-primary mb-5 leading-tight">
                Seamless Contractor Onboarding in Italy with Jackson and Frank
              </h2>
              <p className="text-sm sm:text-base  text-gray-600 leading-relaxed mb-6">
                Simplify the onboarding of independent contractors in Italy using your Jackson and Frank account. Achieve compliance with local regulations in minutes.
              </p>
              <p className="text-sm sm:text-base  text-gray-600 leading-relaxed">
                Our platform handles everything, from personalized contracts to effortless tax document collection (Codice Fiscale, VAT/IVA registration), extending to streamlined international payroll. Make contractor onboarding a breeze for success in the Italian market with Jackson and Frank.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="eor-section lg:py-24 bg-white">
        <div className="max-w-300 mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="section-title text-3xl sm:text-4xl font-bold text-primary mb-5 leading-tight">
                Upholding Compliance with Italy&apos;s Premier Legal Firms at Jackson and Frank
              </h2>
              <p className="text-sm sm:text-base  text-gray-600 leading-relaxed mb-6">
                Trust Jackson and Frank in Italy to ensure compliance with the expertise of the country&apos;s top legal firms. Our contracts undergo meticulous review, aligning with local laws, covering essentials such as collective agreements (CCNL), national holidays, termination conditions, and INPS requirements.
              </p>
              <p className="text-sm sm:text-base  text-gray-600 leading-relaxed">
                Stay confident with accurate and up-to-date information for seamless operations in the Italian business landscape.
              </p>
            </div>
      ...
      <section className="eor-section lg:py-24 bg-linear-to-br from-slate-50 via-blue-50 to-emerald-50">
        <div className="max-w-300 mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-1 lg:order-2">
              <h2 className="section-title text-3xl sm:text-4xl  font-bold text-primary mb-5 leading-tight">
                Streamlined Payroll Funding in Italy - One Click Away with Jackson and Frank
              </h2>
              <p className="text-sm sm:text-base  text-gray-600 leading-relaxed mb-6">
                Simplify your payroll process in Italy with Jackson and Frank. Effortlessly initiate mass payouts in various currencies using your preferred payment method.
              </p>
              <p className="text-sm sm:text-base  text-gray-600 leading-relaxed">
                Team members can conveniently withdraw funds with their chosen payment methods, saving on currency conversions and wire transfer fees. Experience a seamless financial transaction solution tailored for success in the Italian market.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="eor-section lg:py-24 bg-white">
        <div className="max-w-300 mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl">
            ...
            <h2 className="section-title text-3xl sm:text-4xl  font-bold text-primary mb-5 leading-tight">
              Why use contractor management in Italy?
            </h2>
            <div className="space-y-4">
                  <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
                Italy has strict rules on contractor classification. Italian authorities can reclassify contractors as employees (false self-employment), leading to back INPS contributions, taxes, and penalties. Misclassification also risks pulling workers into collective agreement (CCNL) obligations.
              </p>
              <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
                Using a contractor management solution like Jackson & Frank helps you engage contractors compliantly: we assess classification, provide Italian-law contracts, handle payroll and invoicing, and monitor ongoing compliance. If a role becomes permanent, we can convert contractors to employees via our Italy EOR with full INPS, INAIL, and benefits.
              </p>
              <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
                This protects your business, keeps contractors happy with proper agreements and timely payments, and gives you flexibility to scale your Italian workforce without setting up a local entity.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="eor-section lg:py-24 bg-white">
        <div className="max-w-300 mx-auto px-4 sm:px-6 lg:px-8">
          <SectionTitle
            ...
            description="Weigh the benefits and considerations before engaging contractors in Italy."
            align="center"
          />
      ...
      <section className="eor-section lg:py-24 bg-gray-50">
        <div className="max-w-300 mx-auto px-4 sm:px-6 lg:px-8">
          <SectionTitle
            title="Italian Contractor Compliance"
            description="Staying compliant with Italian contractor and employment law protects your business from penalties and ensures genuine contractor relationships."
            align="center"
          />
      ...
      <section className="eor-section md:py-16 bg-white">
        <div className="max-w-300 mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <p className="text-gray-600 mb-4">Need to hire full employees in Italy?</p>
            <Button size="lg" aria-label="Learn more about Italy EOR services" className="bg-primary hover:bg-primary/90 text-white" href="/italy">
              Learn more about Italy EOR
