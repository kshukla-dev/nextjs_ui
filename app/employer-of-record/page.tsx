...
@media (max-width: 960px) {
  .eor-premium-hero {
    ...
    background-image: linear-gradient(rgba(14, 15, 59, 0.8), rgba(14, 15, 59, 0.95)), url(/services/service-page/eor-hero2.png);
  }
}
...
`}</style>
        ...
        <div className="eor-premium-hero-inner">
          <div className="service-hero-copy">
            ...
            <div className="cta-row">
              <Link href="/contact" className="btn-primary">Hire globally without entity setup <span className="arrow">→</span></Link>
              <Link href="/contact" className="btn-secondary" style={{ background: 'white', color: 'var(--dark)', borderColor: 'white' }}>
      ...
      <section className="eor-section eor-container eor-process-panel" id="what-is-eor">
        ...
        <div className="eor-process-steps">
          <div className="eor-process-step">
            <div className="eps-number">01</div>
          ...
          <div className="eor-process-step">
            <div className="eps-number">02</div>
            <div className="eps-body">
          ...
          <div className="eor-process-step">
            <div className="eps-number">03</div>
            <div className="eps-body">
      ...
      <section className="eor-section eor-container">
        <h2 className="how-it-works-title">How it Works: Your Global Hiring Journey</h2>
          ...
          <div className="benefits-grid">
            ...
            <div className="benefit-card">
              ...
              <div style={{ marginTop: '8px' }}>
                <strong style={{ fontSize: '11px', color: '#143369', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Key Benefits</strong>
                <ul style={{ margin: '8px 0 0', paddingLeft: '16px', fontSize: '13px', color: 'var(--gh-on-surface-variant)', display: 'flex', flexDirection: 'column', gap: '4px' }}>
              ...
              <div style={{ marginTop: '8px' }}>
                <strong style={{ fontSize: '11px', color: '#143369', textTransform: 'uppercase', letterSpacing: '0.05em' }}>How it Works</strong>
                <ol style={{ margin: '8px 0 0', paddingLeft: '16px', fontSize: '13px', color: 'var(--gh-on-surface-variant)', display: 'flex', flexDirection: 'column', gap: '4px' }}>
            ...
            <div className="benefit-card">
              <div className="benefit-icon">
                <svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="#143369" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="eor-container">
          ...
          <div className="eor-countries-grid">
            {topCountries.map((country) => (
              <Link href={country.href || `/${country.name.toLowerCase().replace(/\s+/g, '-')}`} className="ecg-item" key={country.code}>
                <div className="ecg-flag-wrapper">
                  <img src={`https://hatscripts.github.io/circle-flags/flags/${country.code}.svg`} alt={country.name} className="ecg-flag" />
          ...
          <div className="eor-countries-cta">
            <Link href="/contact" className="gh-btn-gold">Explore all countries →</Link>
          </div>
        </div>
      </section>
      ...
      <section className="eor-section eor-container">
        <div className="faq-section">
          <h2 className="faq-title mb-6">Frequently Asked Questions</h2>
          <div className="faq-list">
            {faqs.map((faq, i) => (
              <div key={i} className="faq-item">
                <button className="faq-button" onClick={() => toggleFaq(i)} aria-expanded={openFaq === i}>
                ...
                <div style={{ display: openFaq === i ? 'block' : 'none' }} className="faq-answer">
                  <p>{faq.answer}</p>
                </div>
              </div>
            ))}
